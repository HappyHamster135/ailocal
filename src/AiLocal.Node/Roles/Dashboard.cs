    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing: border-box; }
        ...
        .style-card svg { width: 56px; height: 35px; fill: currentColor; opacity: .85; }
    ...
    <body>
            ...
            <div class="composer" id="composer">
              ...
              <div class="composer-box">
                ...
                <div class="style-row" id="styleRow" title="Förhandsvalen skickas med bygget (Agentläge) och blir hårda kontraktspunkter - studion slipper gissa grunderna.">
                  ...
                  <button type="button" class="style-card" data-style="pixelart" title="Äkta pixelart: sluten kontur, 2-3 nyanser per yta, skarpa pixlar (husstilen) - bilden är en riktig kit-skärmdump">
                    <img alt="" src="data:image/png;base64,"><span>Pixelart</span>
                  </button>
                  <button type="button" class="style-card" data-style="iso" title="2.5D: isometrisk pixelvy med djup (romb-tiles, y-sortering) - bilden är en riktig kit-skärmdump">
                    <img alt="" src="data:image/png;base64,"><span>2.5D</span>
                  </button>
                  <button type="button" class="style-card" data-style="3d" title="Riktig 3D: lågpoly med ljussättning och skuggor - bilden är en riktig kit-skärmdump">
                    <img alt="" src="data:image/png;base64,"><span>3D</span>
                  </button>
                  <button type="button" class="style-card" data-style="vektor" title="Ren vektor-2D: platta mjuka former via Art.gd-hjälparna - bilden är en riktig kit-skärmdump">
                    <img alt="" src="data:image/png;base64,"><span>Vektor</span>
                  </button>
          ...
          <div class="settings-content">
            ...
            <section class="settings-pane hidden" data-settings-pane="agent">
              <div class="form-grid">
                ...
                <label>Spelens språk
                  <select id="settingGameLanguage">
                    <option value="en">Engelska (standard)</option>
                    <option value="sv">Svenska</option>
                  </select>
                </label>
                <span class="small" style="display:block;margin-top:-6px">
                  Språket på spelartexten i byggda spel (menyer, HUD, meddelanden). Engelska är
                  professionellt och encodingsäkert; Svenska ger riktiga å/ä/ö i det som byggs.
                  Regissörens kontrakt och kvalitetsgrinden följer valet.
                </span>
                <span class="small" style="display:block;margin-top:-6px">
      ...
      <script>
        ...
        function applySettingsData(data) {
          ...
          $('settingGameLanguage').value = data.gameLanguage ?? 'en';
        ...
        async function saveSettings() {
          ...
          const body = {
            ...
            gameLanguage: $('settingGameLanguage').value,
